      ...
      child: Column(
        ...
        children: [
          Expanded(
              flex: 0,
              child: Column(
                children: [_searchBar(context), _timeBar(context)],
              )),
          Expanded(child: Consumer<ListStudentProvider>(
                          ...
                          child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return Padding(
                                  ...
                                  child: StudentItem(
                                    student: value.lstStudentFilter[index],
        ...
        return Container(
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                  ...
                  hintText:
                      AppLocalizations.of(context).translate("hint_search"),
      ...
      builder: (context, value, child) {
        return DropdownButton<String>(
          ...
          onChanged: (String? currentValue) {
            setState(() {
              provider.timeName = currentValue!;
              MyTime time = value.lstTime
                  .firstWhere((time) => time.name == provider.timeName);

              provider.filterListTimeID(time.id!, () {
                // Hiển thị SnackBar nếu không có học viên
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text(
                      "Không có học viên trong khung giờ này",
                      style: TextStyle(
                          color: Colors.red, fontWeight: FontWeight.bold),
                    ),
                    backgroundColor:
                        Colors.white, // Để nền trắng giúp chữ đỏ nổi bật
