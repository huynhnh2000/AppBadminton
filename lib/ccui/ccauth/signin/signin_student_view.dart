          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(color: AppColors.primary, offset: Offset(0, 0), blurRadius: 30, spreadRadius: 20)
                ]
              ),
              ...
              child: Column(
                ...
                children: [
                  Text(AppLocalizations.of(context).translate("wellcome_back"), style: AppTextstyle.mainTitleStyle, textAlign: TextAlign.center,),
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          filled: true,
          prefixIcon: const Icon(Icons.person, color: Colors.grey, size: 25,),
          hintText: "Code",
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          fillColor: Colors.grey.withOpacity(0.1),
          filled: true,
          prefixIcon: const Icon(Icons.password, color: Colors.grey, size: 25,),
          suffixIcon: IconButton(
            ...
            icon: Icon(isHide?Icons.remove_red_eye_outlined:Icons.remove_red_eye, color: Colors.grey, size: 25,)
          ),
          hintText: "Password",
          hintStyle: AppTextstyle.contentGreySmallStyle,
          labelStyle: AppTextstyle.contentBlackSmallStyle
  ...
  Widget _button(BuildContext context){
    return GestureDetector(
      onTap: () async{
        ...
        await AuthControll().handleLogin(
          context, 
          user: MyUser(code: widget.codeController.text, password: widget.passController.text)
        );
      ...
      child: Container(
        ...
        child: Center(
          child: isLoading?
            ...
            Text("Sign in", style: AppTextstyle.subWhiteTitleStyle,)
        ),
      ),
    );
  }
